      ...
      <div className="relative z-10 w-full max-w-md bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-lg border border-white/20">
        ...
        <form onSubmit={handleLogin}>
          <input
            ...
            disabled={loading}
            className="w-full p-3 mb-4 rounded-xl bg-white/20 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/50 disabled:opacity-50"
          />
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 mt-4 bg-red-600 text-white rounded-xl hover:bg-red-500 transition duration-200 flex items-center justify-center disabled:opacity-70"
          >
